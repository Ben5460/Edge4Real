...
##  Author: Timmothy Lane
    ...
    def mfccProc(self):
        (rate,sig) = audioBasicIO.read_audio_file(self.fname)
...
##Author: Alex Shannon
    def pitchProc(self):
        [Fs,x] = audioBasicIO.read_audio_file(self.fname)
        info=ShortTermFeatures.feature_extraction(x, Fs, 0.050*Fs, 0.025*Fs)
        return info[0][1]
